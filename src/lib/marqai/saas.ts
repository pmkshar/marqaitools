...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    modules: ["dashboard", "seo", "social", "scheduler", "email", "images", "videos", "analyzer", "logo-builder", "website-builder", "leads-generator", "whatsapp", "ai-testing", "ai-testing-methodologies", "reports", "team", "roles", "billing", "wiki", "settings"],
    features: [
      "25 team members",
