...
const MODULE_REPORTS: Omit<ModuleReport, "aiIntegrationStatus" | "lastTestedAt">[] = [
  ...
  },
  {
    ...
    applicableStrategies: ["smoke-post-deploy", "functional", "cross-browser-responsive", "accessibility"],
    applicableScenarios: [],
    notes: "Reference module — renders the AI testing taxonomy playbook (10 AI strategies + 10 AI methodologies + 9 AI scenarios). No AI calls; pure documentation surface.",
  },
  {
    moduleId: "non-ai-testing",
    moduleName: "Non-AI Testing Methodologies",
    category: "Informational",
    functionalCoverage: 100,
    smokeTestStatus: "pass",
    openIssues: 0,
    applicableStrategies: ["smoke-post-deploy", "functional", "cross-browser-responsive", "accessibility"],
    applicableScenarios: [],
    notes: "Reference module — renders the non-AI testing taxonomy playbook (20 non-AI strategies + 19 non-AI methodologies + 14 QA report artifacts). No AI calls; pure documentation surface.",
  },
  {
    moduleId: "bug-tracker",
    moduleName: "Bug Tracker",
    category: "CRUD",
    functionalCoverage: 96,
    smokeTestStatus: "pass",
    openIssues: 0,
    applicableStrategies: ["req-risk-based", "smoke-post-deploy", "functional", "regression", "security-pen", "data-validation"],
    applicableScenarios: [],
    notes: "Bugzilla-style defect tracker for AI + non-AI testing. Every bug links to a methodology from the testing taxonomy. Methodology-wise reports + activity log + triage board. Developer role gets execute/manage access for debugging.",
  },
  {
