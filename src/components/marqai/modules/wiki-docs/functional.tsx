          ...
          <table className="w-full text-xs border">
            ...
            <tbody>
              {[
                ...
                ["AI Leads Generator", "Scale", "AI prospect lists per product with fit scores"],
                ["AI Sales Agents", "Scale", "Conversational sales suite: BANT/MEDDIC qualification, outreach sequences, deal coaching, objection handling, SPIN discovery"],
                ["WhatsApp Marketing", "Scale", "Broadcasts, templates, contacts, Meta Cloud API"],
